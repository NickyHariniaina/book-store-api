package com.onlydevs.bookstore.handler;

import static com.onlydevs.bookstore.concurrency.ThreadRenamer.renameWorkerThread;
...
import com.onlydevs.bookstore.PojaApplication;
import com.onlydevs.bookstore.PojaGenerated;
import com.onlydevs.bookstore.endpoint.EndpointConf;
import com.onlydevs.bookstore.endpoint.event.EventConf;
import com.onlydevs.bookstore.endpoint.event.consumer.EventConsumer;
import com.onlydevs.bookstore.endpoint.event.consumer.model.ConsumableEvent;
import com.onlydevs.bookstore.endpoint.event.consumer.model.ConsumableEventTyper;
