package com.onlydevs.bookstore.endpoint.event.model;

import static com.onlydevs.bookstore.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.onlydevs.bookstore.PojaGenerated;
import com.onlydevs.bookstore.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "com.onlydevs.bookstore.event1";
  }
}
