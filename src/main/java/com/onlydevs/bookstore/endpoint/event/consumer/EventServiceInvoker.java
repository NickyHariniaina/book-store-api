package com.onlydevs.bookstore.endpoint.event.consumer;

import com.onlydevs.bookstore.PojaGenerated;
import com.onlydevs.bookstore.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.onlydevs.bookstore.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.onlydevs.bookstore.service.event."
